...
# Awesome Blockchains with stars
...
For more about Diem (formerly Libra), see the [Awesome Diem (formerly Libra) and Move page »](https://github.com/openblockchains/awesome-diem) ⭐ 62 | 🐛 0 | 📅 2021-05-13

***

For crypto quotes, see the new [**100+ Best of Crypto Quotes - I HODL, you HODL, we HODL! - BREAKING: BITCOIN JUST BROKE $22 000! page »**](https://github.com/openblockchains/crypto-quotes) ⭐ 15 | 🐛 0 | 📅 2021-01-19
...
by Daniel van Flymen, September 2017, [(Source)](https://github.com/dvf/blockchain) ⭐ 8,045 | 🐛 133 | 🌐 C# | 📅 2024-07-21 -- The fastest way to learn how Blockchains work is to build one
...
[**A guide to building a blockchain & cryptocurrency from scratch**](https://antoinefink.com/building-a-blockchain-and-cryptocurrency-in-ruby) [(Source)](https://github.com/antoinefink/melon) ⭐ 18 | 🐛 0 | 🌐 Ruby | 📅 2021-04-29 by Antoine Fink, April 2021
...
[(Source)](https://github.com/bradford-hamilton/crystal-blockchain) ⭐ 21 | 🐛 0 | 🌐 Crystal | 📅 2018-11-13
...
[**Build your own Blockchain in Javascript/Visualization of Blockchains**](https://github.com/nambrot/blockchain-in-js) ⭐ 1,133 | 🐛 2 | 🌐 JavaScript | 📅 2022-03-17 by Nam Chu Hoai,  January 2018

### TypeScript

[**Naivecoin: a tutorial for building a cryptocurrency**](https://lhartikk.github.io) by Lauri Hartikka, [(Source)](https://github.com/lhartikk/naivecoin) ⭐ 564 | 🐛 21 | 🌐 TypeScript | 📅 2022-03-31

### Java

[**Creating Your First Blockchain with Java, Part 1**](https://medium.com/programmers-blockchain/create-simple-blockchain-java-tutorial-from-scratch-6eeed3cb03fa) by Kass, December 2017, [(Source)](https://github.com/CryptoKass/NoobChain-Tutorial-Part-1) ⭐ 332 | 🐛 2 | 🌐 Java | 📅 2021-06-28
...
[(Source)](https://github.com/VasilyFomin/kCoin) ⭐ 42 | 🐛 0 | 🌐 Kotlin | 📅 2018-07-15

### SQL

[**Blockchain by Example in SQL Server**](https://medium.com/@benjaminsky/blockchain-by-example-in-sql-server-8376b410128) by Benjamin Campbell, December 2017, [(Source)](https://github.com/benjaminsky/BlockchainMessenger) ⭐ 7 | 🐛 0 | 🌐 PLpgSQL | 📅 2018-01-31

### Rust

**Building Blockchain in Rust Series** by Jacob Lindahl, GeekLaunch, [(Source)](https://github.com/GeekLaunch/blockchain-rust) ⭐ 198 | 🐛 3 | 🌐 Rust | 📅 2021-03-05, [(Slide Decks in PDF)](https://github.com/GeekLaunch/slides) ⭐ 2 | 🐛 0 | 📅 2019-02-21
...
**Building Blockchain in Go Series** by Ivan Kuznetsov, [(Source)](https://github.com/Jeiwan/blockchain_go) ⭐ 4,375 | 🐛 53 | 🌐 Go | 📅 2024-06-20
...
See [**Build your own Blockchain / Cryptocurrency**](https://github.com/danistefanovic/build-your-own-x#build-your-own-blockchain--cryptocurrency) ⭐ 541,990 | 🐛 635 | 🌐 Markdown | 📅 2026-07-14 @ Build your own (insert technology here)
...
> > In this implementation that happens as the previous digest is input in the calc\_hash method.

**What about Proof of Work / Waste?**

Let's add a proof of work / waste to the blockchain. In the classic blockchain you have to compute a block hash that starts with leading zeros (`00`). The more leading zeros the harder (more difficult) to compute. Let's keep it easy to compute with two leading zeros (`00`), that is, 16^2 = 256 possibilites (^1,2). Three leading zeros (`000`) would be 16^3 = 4\_096 possibilites and four zeros (`0000`) would be 16^4 = 65\_536 and so on.
...
Properties of the (minimum viable) blockchain*
...
[**Mastering Bitcoin - Programming the Open Blockchain**](https://github.com/bitcoinbook/bitcoinbook/blob/second_edition/ch09.asciidoc) ⭐ 25,291 | 🐛 191 | 🌐 HTML | 📅 2024-12-26 2nd Edition,
...
[**Programming Bitcoin from Scratch**](https://github.com/jimmysong/programmingbitcoin) ⭐ 1,884 | 🐛 120 | 🌐 Python | 📅 2024-05-20 by Jimmy Song, 2019 - FREE (Online Source Version) -- *[Chapter 6 - Script](https://github.com/jimmysong/programmingbitcoin/blob/master/ch06.asciidoc) ⭐ 1,884 | 🐛 120 | 🌐 Python | 📅 2024-05-20 - How Script Works • Example Operations • Parsing the Script Fields • Combining the Script Fields • Standard Scripts • p2pk • Problems with p2pk • Solving the Problems with p2pkh • Scripts Can Be Arbitrarily Constructed • Conclusion ++*
*[Chapter 8 - Pay-to-Script Hash](https://github.com/jimmysong/programmingbitcoin/blob/master/ch08.asciidoc) ⭐ 1,884 | 🐛 120 | 🌐 Python | 📅 2024-05-20 - Bare Multisig • Coding OP\_CHECKMULTISIG • Problems with Bare Multisig • Pay-to-Script-Hash (p2sh) • Coding p2sh • Conclusion ++*
*[Chapter 13 - Segregated Witness](https://github.com/jimmysong/programmingbitcoin/blob/master/ch13.asciidoc) ⭐ 1,884 | 🐛 120 | 🌐 Python | 📅 2024-05-20 - Pay-to-Witness-Pubkey-Hash (p2wpkh) • p2wpkh Transactions • p2sh-p2wpkh • Coding p2wpkh and p2sh-p2wpkh • Pay-to-Witness-Script-Hash (p2wsh) • p2sh-p2wsh • Coding p2wsh and p2sh-p2wsh • Other Improvements • Conclusion*
...
[**Mastering Ethereum - Building Contract Services and Decentralized Apps on the Blockchain**](https://github.com/ethereumbook/ethereumbook) ⭐ 21,516 | 🐛 2 | 📅 2026-05-13 -
...
[**Programming Crypto Blockchain Contracts Step-by-Step Book / Guide ( Beta / Rough Draft )**](https://github.com/openblockchains/programming-cryptocontracts) ⭐ 92 | 🐛 0 | 🌐 Ruby | 📅 2021-01-02 by Gerald Bauer et al, 2019 - FREE (Online Version) --
...
[**Best of Bitcoin Maximalist - Scammers, Morons, Clowns, Shills & BagHODLers - Inside The New New Crypto Ponzi Economics**](https://github.com/bitsblocks/bitcoin-maximalist) ⭐ 9 | 🐛 0 | 📅 2020-12-13 by Trolly McTrollface, et al, 2018 - FREE

[**Crypto Facts - Decentralize Payments - Efficient, Low Cost, Fair, Clean - True or False?**](https://github.com/bitsblocks/crypto-facts) ⭐ 3 | 🐛 0 | 📅 2020-01-09 by Nouriel Roubini, David Gerard, et al, 2018 - FREE

[**Crypto is the Mother of All Scams and (Now Busted) Bubbles - While Blockchain Is The Most Over-Hyped Technology Ever, No Better than a Spreadsheet/Database**](https://github.com/bitsblocks/crypto-bubbles) ⭐ 5 | 🐛 0 | 📅 2020-01-10 by Nouriel Roubini, 2018 - FREE
...
**blockchain.lite** (github: [openblockchains/blockchain.lite.rb](https://github.com/openblockchains/blockchain.lite.rb) ⭐ 238 | 🐛 0 | 🌐 Ruby | 📅 2023-12-18,
...
[**Shilling (or Schilling)**](https://github.com/bitshilling/bitshilling) ⭐ 11 | 🐛 0 | 📅 2022-08-09 - Shilling on the Blockchain! - Rock-Solid Alpine Dollar from Austria
...
More @ [cryptocopycats/awesome-cryptokitties](https://github.com/cryptocopycats/awesome-cryptokitties) ⭐ 522 | 🐛 0 | 🌐 Ruby | 📅 2021-04-21
...
* [**Awesome**](https://github.com/sindresorhus/awesome) ⭐ 498,795 | 🐛 105 | 📅 2026-08-21 by Sindre Sorhus et al -- a curated list of awesome lists
* [**Awesome Coins**](https://github.com/kennethreitz/awesome-coins) ⭐ 4,094 | 🐛 23 | 📅 2023-07-20 by Kenneth Reitz et al -- a guide to crypto-currencies and their algos
* [**Awesome Git**](https://github.com/dictcp/awesome-git) ⭐ 2,931 | 🐛 68 | 📅 2026-07-07 by Dick Tang et al -- a curated list of amazingly awesome Git tools, resources and shiny things
